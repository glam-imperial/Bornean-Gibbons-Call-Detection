...
Added additional event signalling parameter for multitheaded process cancelation.
...
class StoppableDataGenerator(keras.utils.Sequence):

    def __init__(self, list_IDs, labels, npy_folder, killEvent, batch_size=32, dim=(128, 431), n_channels=1, n_classes=2, shuffle=True):
        self.dim = dim
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            if self.killEvent.is_set():
                print("Kill event - halting prediction")
                return
